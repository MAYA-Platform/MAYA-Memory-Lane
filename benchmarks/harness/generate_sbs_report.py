...
Sources used:
  ...
  - internal competitor-research notes (vendor claims, cited)
...
A("| Main model (DeepSeek v4-flash via DeepSeek) | 40% | 60% | ~$0.00004 | `results/LLM_BACKEND_COMPARISON.md` (10-q pilot) |")
A("")
...
A("")
A("From the competitor study (repos cloned + read, 2026-08-04). ✅ = present, ❌ = absent, ⚠️ = partial/optional.")
A("")
